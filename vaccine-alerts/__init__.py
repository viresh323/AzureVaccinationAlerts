...
headers = {
    ...
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3918.79 Safari/537.36',
    'Sec-Fetch-User': '?1',
...
def GetWebRequestData(url):
    try:
        ...
        index = url.find("/calendarByDistrict")
        modifiedUrl = url[:index] + "/public" + url[index:]
...
def sendToTelegram(text):
    ...
    for i in range(0, len(text), 3800):
        url = urlString.format(
            "1313482390:AAETcnSaHfG_51hIsVQjpzp-RM3T9_yVi2DY", "-5712388614", text[i:i+3800])
